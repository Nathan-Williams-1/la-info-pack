# Code of conduct for `la_info_pack`
...
- "Project", we mean this `la_info_pack` GitHub repository;
...
[nathan.williams@ons.gov.uk][email-address]. All complaints will be
...
[email-address]: mailto:nathan.williams@ons.gov.uk
