...
Generate demographic breakdowns for Census Field Officers
...
```shell
python src/la_info_pack/run_pipeline.py
```
...
[If you want to help us build, and improve `la_info_pack`, view our
